...
//    }
    ...
    b.fn.uploadFile = function (f) {
        ...
        function k(D, C, z, x) {
            ...
            if (z.nestedForms) {
                B.css({margin: 0, padding: 0});
                x.css({position: "relative", overflow: "hidden", cursor: "default"});
                A.css({position: "absolute", cursor: "pointer", top: "0px", width: "100%", height: "100%", left: "0px", "z-index": "100", opacity: "0.0", filter: "alpha(opacity=0)", "-ms-filter": "alpha(opacity=0)", "-khtml-opacity": "0.0", "-moz-opacity": "0.0"});
                B.appendTo(x)
            } else {
                B.appendTo(b("body"));
                B.css({margin: 0, padding: 0, display: "block", position: "absolute", left: "-250px"});
        ...
        function w(D, C, x, z, E, B) {
            var A = null;
            var y = {cache: false, contentType: false, processData: false, forceSync: false, type: C.method, data: C.formData, formData: C.fileData, dataType: C.returnType, beforeSubmit: function (J, G, I) {
