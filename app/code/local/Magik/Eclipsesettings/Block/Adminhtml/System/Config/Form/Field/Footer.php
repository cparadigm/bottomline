...
class Magik_Eclipsesettings_Block_Adminhtml_System_Config_Form_Field_Footer extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    {
	    $html = '<div class="a-left">';
	    $html .= '<img src="'.Mage::getDesign()->getSkinUrl('images/magik/eclipse/footer_'.$option['value'].'.jpg').'" alt="" /><br/>';
