...
class Magik_Eclipsesettings_Model_Settings extends Mage_Core_Model_Abstract
{
    /**
     * theme settings
     *
    ...
    public function __construct()
    {
	    ...
	    $filePath = Mage::getBaseDir().'/app/code/local/Magik/Eclipsesettings/etc/eclipse.xml';
