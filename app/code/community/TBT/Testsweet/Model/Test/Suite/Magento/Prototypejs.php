    ...
    protected function generateSummary() {
        ...
        if ($content) {
            ...
            if( strpos($version, 'version 1.7') !== false) {
                ...
                $this->addWarning($this->__("Prototype JavaScript framework is version 1.6.0.3 and might have issues with IE9"));
            } else {
                // Ignore unknown version because it's likly compatible
