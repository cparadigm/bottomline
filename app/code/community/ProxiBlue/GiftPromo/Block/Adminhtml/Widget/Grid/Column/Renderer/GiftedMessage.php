    ...
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    private function renderMessage(Varien_Object $row)
    {
        ...
        $text = $this->escapeHtml(Mage::helper('core/string')->truncate($row->getGiftedMessage(), $truncateLength));
         return 
                '<div style="white-space: nowrap"><input style="margin-left: 5px;width:' . $this->getColumn()->getMessageWidth() . 'px !important;" type="text" class="input-text input-gifted-message"'
                . '" name="gifted_message"'        
                . ' value="'.$text.'"/></div>';
    }
    ...
    private function renderLabel(Varien_Object $row)
    {
        ...
        return 
                '<input style="margin-left: 5px; margin-bottom: 5px; width:' . $this->getColumn()->getLabelWidth() . 'px !important;" type="text" class="input-text input-gifted-label"'
                . '" name="gifted_label"'        
                . ' value="'.$text.'"/>';
    }
