 ...
 */
class ProxiBlue_GiftPromo_Block_AdminHtml_Promo_Rule_Edit_Tab_Actions_GiftPromo_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('catalog/product')->getCollection()  
                ->addFieldToFilter('type_id', array('in' => 
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('gifted_message', array(
        ...
        $this->addColumn('gifted_price', array(
        ...
        $this->addColumn('gifted_qty_rate', array(
        ...
        $this->addColumn('gifted_qty_max', array(
        ...
        $this->addColumn('gifted_position', array(
    ...
    public function getGridUrl() {
        return $this->getData('grid_url') ? $this->getData('grid_url') : $this->getUrl('*/*/giftpromoGrid', array('_current' => true));
    }
