 ...
 */
class ProxiBlue_GiftPromo_Model_Promo_Rule_Condition_Twitter_Conditions_Follow extends ProxiBlue_GiftPromo_Model_Promo_Rule_Condition_Twitter_Api {
    ...
    public function asHtml() {
        $html = $this->getTypeElement()->getHtml() .
                Mage::helper('giftpromo')->__("If the customer %s the twitter account:  <b>%s</b>", $this->getOperatorElement()->getHtml(), ProxiBlue_GiftPromo_Model_Promo_Rule_Condition_Twitter_Conditions::getTwitterHandle());
        if ($this->getId() != '1') {
    ...
    public function validate(Varien_Object $object) {
        ...
        if (is_object($customer) && $customer->getId()) {
            ...
            try {
                ...
                $getfield = '?screen_name=' . ProxiBlue_GiftPromo_Model_Promo_Rule_Condition_Twitter_Conditions::getTwitterHandle()
