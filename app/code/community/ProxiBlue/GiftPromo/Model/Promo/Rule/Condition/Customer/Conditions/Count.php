 ...
 */
class ProxiBlue_GiftPromo_Model_Promo_Rule_Condition_Customer_Conditions_Count extends Mage_Rule_Model_Condition_Abstract {
    ...
    public function asHtml() {
        $html = $this->getTypeElement()->getHtml() .
                Mage::helper('giftpromo')->__("If this gifting rule had been applied to the customer %s %s times. (<b>equals to 0</b> times = never)", $this->getOperatorElement()->getHtml(), $this->getValueElement()->getHtml());
        if ($this->getId() != '1') {
