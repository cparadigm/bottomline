 ...
 */
class ProxiBlue_GiftPromo_Model_Product_Type_Gift_Configurable_Price extends Mage_Catalog_Model_Product_Type_Configurable_Price {
    ...
    public function getFinalPrice($qty = null, $product) {
        ...
        if (is_null($product->getGiftedPrice())) {
            $giftProductModel = Mage::getModel('giftpromo/product')->cloneProduct($product, true);
