<?php
class Magik_Onestepcheckout_IndexController extends Mage_Checkout_Controller_Action
{
    ...
    {
        return Mage::getSingleton('onestepcheckout/type_opcheckout');
    }
    ...
    {    	
        ...
        $title	= Mage::getStoreConfig('mgkonestepcheckout_section/mgkopcgeneral_group/mgkopcpagetitle');
    ...
    public function updateCheckoutAction()
    {
        ...
        $this->getOnepagecheckout()->usePayment(isset($paymentData['method']) ? $paymentData['method'] : null);
        $couponChanged 		= false;
