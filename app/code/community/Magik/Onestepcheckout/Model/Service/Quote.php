<?php
class Magik_Onestepcheckout_Model_Service_Quote extends Mage_Sales_Model_Service_Quote
{
    protected function _validate()
    {
        ...
        if (!$this->getQuote()->isVirtual())
        {
            ...
            $addrValidator = Mage::getSingleton('onestepcheckout/type_opcheckout')->validateAddress($address);
        ...
        $addrValidator = Mage::getSingleton('onestepcheckout/type_opcheckout')->validateAddress($this->getQuote()->getBillingAddress());
