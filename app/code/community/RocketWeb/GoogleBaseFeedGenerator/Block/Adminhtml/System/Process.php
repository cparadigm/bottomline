        ...
        try {
            ...
            if (!$this->getTestMode()) {
                ...
                if ($count > $Generator->getConfigVar('button_max_products', 'file')) {
                    Mage::throwException(sprintf("Too many products. Detected %d products more than the limit allowed of %d.", $count, $Generator->getConfigVar('button_max_products', 'file')));
                }
            }
