...
class RocketWeb_GoogleBaseFeedGenerator_Model_Config extends Mage_Core_Model_Config_Data
{
    ...
    {
        $on = $this->getConfigVar('is_turned_on');
    ...
    public function isAllowConfigurableMode($store_id = null)
    {
        ...
        $allow = array(
            RocketWeb_GoogleBaseFeedGenerator_Model_Source_Assocprodsmode::ONLY_PARENT,
            RocketWeb_GoogleBaseFeedGenerator_Model_Source_Assocprodsmode::BOTH_PARENT_ASSOCIATED
        );
    ...
    public function isAllowApparelConfigurableMode($store_id = null)
    {
        ...
        return ($cfg == RocketWeb_GoogleBaseFeedGenerator_Model_Source_Apparel_Assocprodsmode::BOTH_PARENT_ASSOCIATED);
    }
    ...
    public function isAllowBundleMode($store_id = null)
    {
        ...
        $allow = array(
            RocketWeb_GoogleBaseFeedGenerator_Model_Source_Bundleassocprodsmode::ONLY_BUNDLE,
            RocketWeb_GoogleBaseFeedGenerator_Model_Source_Bundleassocprodsmode::BOTH_BUNDLE_ASSOCIATED
        );
        if (array_search($cfg, $allow) !== false) {
            $ret = true;
        }
    ...
    public function isAllowBundleAssociatedMode($store_id = null)
    {
        ...
        $cfg = $this->getConfigVar('associated_products_mode', $store_id, 'bundle_products');
        $allow = array(
            RocketWeb_GoogleBaseFeedGenerator_Model_Source_Bundleassocprodsmode::ONLY_ASSOCIATED,
            RocketWeb_GoogleBaseFeedGenerator_Model_Source_Bundleassocprodsmode::BOTH_BUNDLE_ASSOCIATED);
        if (array_search($cfg, $allow) !== false) {
            $ret = true;
        }
